...
stateFunctions = {
	...
	--[[TYPING]] function()
		...
		addButton(images.n0, 0, 0, function() inputWrite(0) end)
		addButton(images.n1, 0, 0, function() inputWrite(1) end)
		addButton(images.n2, 0, 0, function() inputWrite(2) end)
		addButton(images.n3, 0, 0, function() inputWrite(3) end)
		addButton(images.n4, 0, 0, function() inputWrite(4) end)
		addButton(images.n5, 0, 0, function() inputWrite(5) end)
		addButton(images.n6, 0, 0, function() inputWrite(6) end)
		addButton(images.n7, 0, 0, function() inputWrite(7) end)
		addButton(images.n8, 0, 0, function() inputWrite(8) end)
		addButton(images.n9, 0, 0, function() inputWrite(9) end)
		addButton(images.delete, 0, 0, function() inputDelete() end)
		addButton(images.accept, 0, 0, function() inputAccept() end)
	end,
